...
public:
  ...
  ContextFixture() {
    ...
    context =
        RationalScoreContext<T>(a, b, N, risk_partitioning_objective, use_rational_optimization);
  }
...
BENCHMARK_TEMPLATE_DEFINE_F(ContextFixture, BM_float_compute_partial_sums_serial, float)
...
BENCHMARK_TEMPLATE_DEFINE_F(ContextFixture, BM_float_compute_partial_sums_AVX256, float)
(benchmark::State& state) {
  for (auto _ : state) {
...
BENCHMARK_TEMPLATE_DEFINE_F(ContextFixture, BM_float_compute_partial_sums_parallel, float)
(benchmark::State& state) {
  for (auto _ : state) {
...
BENCHMARK_TEMPLATE_DEFINE_F(ContextFixture, BM_float_compute_scores_serial, float)
(benchmark::State& state) {
  for (auto _ : state) {
...
BENCHMARK_TEMPLATE_DEFINE_F(ContextFixture, BM_float_compute_scores_AVX256, float)
(benchmark::State& state) {
  for (auto _ : state) {
...
BENCHMARK_TEMPLATE_DEFINE_F(ContextFixture, BM_float_compute_scores_parallel, float)
(benchmark::State& state) {
  for (auto _ : state) {
...
BENCHMARK_TEMPLATE_DEFINE_F(ContextFixture, BM_double_create_DPSolver, double)
(benchmark::State& state) {
  int n = 1 << 11, T = 500;
