...
auto main(int argc, char** argv) -> int {
  ...
  */
  ...
  desc.add_options()("help,h", "Help screen")("loss", value<classifierLossFunction>(&loss), "loss")(
      ...
      "childMinimumGainSplit")("minLeafSize", value<std::size_t>(&minLeafSize), "minLeafSize")(
