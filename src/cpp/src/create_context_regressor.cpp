...
auto main(int argc, char** argv) -> int {
  ...
  */
  ...
  desc.add_options()("help,h", "Help screen")("loss", value<regressorLossFunction>(&loss), "loss")(
      ...
      "lower_val", value<double>(&lower_val), "lower_val")("steps", value<int>(&steps), "steps")(
      ...
      "childPartitionSize",
      value<std::vector<std::size_t>>(&childPartitionSize)->multitoken(),
      "childPartitionSize")(
      "childNumSteps",
      value<std::vector<std::size_t>>(&childNumSteps)->multitoken(),
      "childNumSteps")(
      "childLearningRate",
      value<std::vector<double>>(&childLearningRate)->multitoken(),
      "childLearningRate")(
      "childActivePartitionRatio",
      value<std::vector<double>>(&childActivePartitionRatio)->multitoken(),
      "childActivePartitionRatio")(
      "childMinLeafSize",
      value<std::vector<std::size_t>>(&childMinLeafSize)->multitoken(),
      "childMinLeafSize")(
      "childMaxDepth",
      value<std::vector<std::size_t>>(&childMaxDepth)->multitoken(),
      "childMaxDepth")(
      "childMinimumGainSplit",
      value<std::vector<double>>(&childMinimumGainSplit)->multitoken(),
      "childMinimumGainSplit")("numTrees", value<std::size_t>(&numTrees), "numTrees")(
