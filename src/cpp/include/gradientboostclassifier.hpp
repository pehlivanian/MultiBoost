...
CEREAL_REGISTER_POLYMORPHIC_RELATION(ModelDTCD, CompositeClassifierDTC);
CEREAL_REGISTER_POLYMORPHIC_RELATION(ModelDTCF, CompositeClassifierDTC);
CEREAL_REGISTER_POLYMORPHIC_RELATION(ModelRFCD, CompositeClassifierRFC);
CEREAL_REGISTER_POLYMORPHIC_RELATION(ModelRFCF, CompositeClassifierRFC);

CEREAL_REGISTER_POLYMORPHIC_RELATION(ModelDTCD, GradientBoostClassifierDTC);
CEREAL_REGISTER_POLYMORPHIC_RELATION(ModelDTCF, GradientBoostClassifierDTC); 
CEREAL_REGISTER_POLYMORPHIC_RELATION(ModelRFCD, GradientBoostClassifierRFC)
CEREAL_REGISTER_POLYMORPHIC_RELATION(ModelRFCF, GradientBoostClassifierRFC);
