...
struct _is_double
    : bool_constant<std::is_same<double, typename std::remove_cv<DataType>::type>::value> {};
...
public:
  ...
  */
  ...
  zip_iterator(const zip_iterator& rhs)
      : m_iter_1_begin{rhs.m_iter_1_begin}, m_iter_2_begin{rhs.m_iter_2_begin} {}
  ...
  auto operator!=(zip_iterator const& rhs) { return !(*this == rhs); }

  auto operator==(zip_iterator const& rhs) {
    return rhs.m_iter_1_begin == m_iter_1_begin || rhs.m_iter_2_begin == m_iter_2_begin;
  }

  auto operator*() -> value_type { return value_type{*m_iter_1_begin, *m_iter_2_begin}; }

  auto operator->() -> pointer_type { return pointer_type{m_iter_1_begin, m_iter_2_begin}; }
...
public:
  ...
  explicit zipper(V&& a, W&& b) : m_a{std::forward<V>(a)}, m_b{std::forward<W>(b)} {}
