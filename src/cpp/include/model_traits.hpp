...
using AllClassifierArgs = std::tuple<
    std::size_t,   // (0) numClasses
...
// std::size_t>; using NegativeFeedbackRandomForestClassifierType =
// NegativeFeedback<RandomForestClassifier, 								std::size_t, std::size_t, double, std::size_t>;
...
// using DecisionTreeClassifierType = DecisionTree<GiniGain, BestBinaryNumericSplit,
// AllCategoricalSplit, AllDimensionSelect, true>; using DecisionTreeClassifierType =
// DecisionTreeRegressor<MADGain>; using DecisionTreeClassifierType = DecisionTreeRegressor<>; using
// DecisionTreeClassifierType = DecisionTreeRegressor<MSEGain, BestBinaryNumericSplit,
// AllCategoricalSplit, AllDimensionSelect, true>; using DecisionTreeClassifierType =
// DecisionTreeRegressor<InformationGain, BestBinaryNumericSplit, AllCategoricalSplit,
// AllDimensionSelect, true>;
...
template <>
struct model_traits<
    DecoratorClassifier<DecisionTreeClassifier, std::size_t, std::size_t, double, std::size_t>> {
...
template <>
struct model_traits<
    NegativeFeedback<DecisionTreeClassifier, std::size_t, std::size_t, double, std::size_t>> {
  using datatype = model_traits<DecisionTreeClassifier>::datatype;
  using integrallabeltype = model_traits<DecisionTreeClassifier>::integrallabeltype;
  using model = model_traits<DecisionTreeClassifier>::model;
  using modelArgs = model_traits<DecisionTreeClassifier>::modelArgs;
...
using AllRegressorArgs = std::tuple<
    std::size_t,   // (0) minLeafSize
...
// [======--===============]
// using DecisionTreeRegressorRegressorType  = DecisionTreeRegressor<MADGain,
// BestBinaryNumericSplit>; using DecisionTreeRegressorRegressorType = DecisionTreeRegressor<>;
// using DecisionTreeRegressorRegressorType = DecisionTreeRegressor<MSEGain, BestBinaryNumericSplit,
// AllCategoricalSplit, AllDimensionSelect, true>; using DecisionTreeRegressorRegressorType =
// DecisionTreeRegressor<InformationGain, BestBinaryNumericSplit, AllCategoricalSplit,
// AllDimensionSelect, true>; using DecisionTreeRegressorRegressorType =
// DecisionTreeRegressor<MADGain, BestBinaryNumericSplit, AllCategoricalSplit, AllDimensionSelect,
// true>;
