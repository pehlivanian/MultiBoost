...
pub async fn main() -> Result<(), Box<dyn std::error::Error>> {
	...
	case{lossFn: 11, clampGradient: 1, upperVal: 1.0, lowerVal: -1.0, childPartitionUsageRatio: vec![0.5]}, // Synth loss - cube root multiplicative
        ];

	/*
    let cases: Vec<case> = vec![
        case{lossFn: 11, clampGradient: 1, upperVal: 1.0, lowerVal: -1.0, childPartitionUsageRatio: vec![0.0]},
        case{lossFn: 11, clampGradient: 1, upperVal: 1.0, lowerVal: -1.0, childPartitionUsageRatio: vec![0.5]},
    ];
	*/
    ...
    for case in cases {
        ...
        childPartitionUsageRatio = case.childPartitionUsageRatio;
